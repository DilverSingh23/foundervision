...
const navbar = () => {
    return (
        <div className="flex justify-center align-middle w-full h-fit mt-5 gap-10 md:gap-100 lg:gap-160">
            <div className="flex justify-center align-middle gap-1.5 md:gap-2.5">
