    ...
    return (
        <div className="flex flex-col font-inter justify-center items-center mt-20">
            ...
            <div className="flex flex-row gap-10 justify-center items-center mt-15 w-fit">
                ...
                <img src="guide-image1.png" alt="Example Prompt" className={`self-center justify-self-center w-170 rounded-4xl transition-all duration-800  ${guide1InView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"}`}/>
            </div>
            <div className="flex flex-row gap-10 justify-center items-center mt-40 w-fit">
                <img src="guide-image2.png" alt="View Canvas Image" className={`self-center justify-self-center w-170 rounded-4xl transition-all duration-800  ${guide2InView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-full"}`}/>
                <div className={`flex flex-col gap-5 border-r-3 pr-3 border-red-500 transition-all duration-800  ${guide2InView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"}`}ref={guide2}>
            ...
            <div className="flex flex-row gap-10 justify-center items-center mt-40 w-fit">
                ...
                <img src="guide-image3.png" alt="Download Button Image" className={`self-center justify-self-center w-170 rounded-4xl transition-all duration-800  ${guide3InView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"}`}/>
            </div>            
        </div>    
)}
