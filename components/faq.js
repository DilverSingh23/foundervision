...
const faq = () => {
    ...
    return (
        <div className="flex flex-col font-inter justify-center items-center mt-30 gap-y-15">
            ...
            <div className={`flex flex-col h-fit w-250 bg-black rounded-4xl transition-all duration-800 ${questionsInView ? "translate-y-0 opacity-100" : "translate-y-75 opacity-0"}`} ref={questions}> 
